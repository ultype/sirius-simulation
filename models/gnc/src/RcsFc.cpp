...
void RCS_FC::enable_rcs() {
    rcs_type = ON_OFF_RCS;
}

void RCS_FC::disable_rcs() {
    rcs_type = NO_RCS;
}

bool RCS_FC::isEnabled() {
    return rcs_type > 0;
}

void RCS_FC::set_mode(enum RCS_FC::RCS_MODE in) {
    rcs_mode = in;
}
