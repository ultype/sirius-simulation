...
static struct icf_ctrl_port g_egse_port[] = {
    ...
    {HIL_RS422_INTF, HW_PORT1, "/dev/ttyAP0", EMPTY_NETPORT,    RS422_DEVICE_TYPE,     NULL, NULL},
    {HIL_RS422_INTF, HW_PORT2, "/dev/ttyAP1", EMPTY_NETPORT,    RS422_DEVICE_TYPE,     NULL, NULL},
    {HIL_RS422_INTF, HW_PORT3, "/dev/ttyAP2", EMPTY_NETPORT,    RS422_DEVICE_TYPE,     NULL, NULL},
    {HIL_RS422_INTF, HW_PORT4, "/dev/ttyAP3", EMPTY_NETPORT,    RS422_DEVICE_TYPE,     NULL, NULL},
    ...
    {HIL_RS422_INTF, HW_PORT7, "/dev/ttyAP6", EMPTY_NETPORT,    RS422_DEVICE_TYPE,     NULL, NULL},
