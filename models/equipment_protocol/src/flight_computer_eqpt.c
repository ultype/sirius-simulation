...
static const  struct fc_can_info_t cmd_dispatch_map[] = {
    ...
    {FC_to_PFS_III, PFS_FILLING, EGSE_EMPTY_SW_QIDX},
    {FC_to_PFS_III, PFS_FLY_MODE, EGSE_EMPTY_SW_QIDX},
    {FC_to_PFS_III, PFS_24V_PWR, EGSE_FLIGHT_COMPUTER_SW_QIDX},
    ...
    {FC_to_PFS_II, PFS_FILLING, EGSE_EMPTY_SW_QIDX},
    {FC_to_PFS_II, PFS_FLY_MODE, EGSE_EMPTY_SW_QIDX},
    {FC_to_PFS_II, PFS_24V_PWR, EGSE_FLIGHT_COMPUTER_SW_QIDX},
