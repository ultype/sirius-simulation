...
extern "C" void record_gps() {
    ...
    // drg->add_variable("rkt.kinematics._TBD[0][0]");
    // drg->add_variable("rkt.kinematics._TBD[0][1]");
    // drg->add_variable("rkt.kinematics._TBD[0][2]");
    // drg->add_variable("rkt.kinematics._TBD[1][0]");
    // drg->add_variable("rkt.kinematics._TBD[1][1]");
    // drg->add_variable("rkt.kinematics._TBD[1][2]");
    // drg->add_variable("rkt.kinematics._TBD[2][0]");
    // drg->add_variable("rkt.kinematics._TBD[2][1]");
    // drg->add_variable("rkt.kinematics._TBD[2][2]");
    ...
    drg->add_variable("rkt.kinematics.psibdx");
    drg->add_variable("rkt.kinematics.thtbdx");
    drg->add_variable("rkt.kinematics.phibdx");
    ...
    // drg->add_variable("rkt.env.wind->_VAED[1]");
    // drg->add_variable("rkt.env.wind->_VAED[2]");
    // drg->add_variable("rkt.kinematics._VBAB[0]");
    // drg->add_variable("rkt.kinematics._VBAB[1]");
    // drg->add_variable("rkt.kinematics._VBAB[2]");
    ...
    drg->add_variable("rkt.tvc.s3_act1_y2");
    drg->add_variable("rkt.tvc.s3_act2_y2");
    drg->add_variable("rkt.tvc.s3_act3_y2");
    drg->add_variable("rkt.tvc.s3_act4_y2");
