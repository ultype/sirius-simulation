...
extern "C" void record_gps() {
    ...
    // drg->add_variable("rkt.forces._f_S2_TWD[0]");
    // drg->add_variable("rkt.forces._f_S2_TWD[1]");
    // drg->add_variable("rkt.forces._f_S2_TWD[2]");
    // drg->add_variable("rkt.forces._f_S2_TWD[3]");
    // drg->add_variable("rkt.forces._f_S2_TWD[4]");
    // drg->add_variable("rkt.forces._f_S2_TWD[5]");
    // drg->add_variable("rkt.forces._f_S2_TWD[6]");
    // drg->add_variable("rkt.forces._f_S2_TWD[7]");
    // drg->add_variable("rkt.forces._f_S2_TWD[8]");
    // drg->add_variable("rkt.forces._f_S2_TWD[9]");
