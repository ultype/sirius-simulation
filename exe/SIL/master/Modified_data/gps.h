#ifndef EXE_SIL_MASTER_MODIFIED_DATA_GPS_H_
#define EXE_SIL_MASTER_MODIFIED_DATA_GPS_H_
...
extern "C" void record_gps() {
    ...
    drg->add_variable("rkt.forces.its");
...
#endif  // EXE_SIL_MASTER_MODIFIED_DATA_GPS_H_
