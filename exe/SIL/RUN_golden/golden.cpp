...
extern "C" int run_me() {
    ...
    */
    ...
    fc.gps.PR_NOISE[0] = 0.25;
    fc.gps.PR_NOISE[1] = 0.25;
    fc.gps.PR_NOISE[2] = 0.25;
    fc.gps.PR_NOISE[3] = 0.25;

    // Delta-range noise - m/s MARKOV  module gps
    fc.gps.DR_NOISE[0] = 0.03;
    fc.gps.DR_NOISE[1] = 0.03;
    fc.gps.DR_NOISE[2] = 0.03;
    fc.gps.DR_NOISE[3] = 0.03;
